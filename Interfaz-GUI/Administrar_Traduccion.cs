...
namespace Interfaz_GUI
{
    public partial class Administrar_Traduccion : Form, IObserver
    {
        ...
        void Alta(string NombreIdioma, string Original, string Traducido)
        {
            ...
            Seguridad.CargarBitacora(Propiedades_BE.SingletonLogIn.GlobalIdUsuario, DateTime.Now, "Alta Traduccion", "Baja",0);
        ...
        void Baja(int IdTraduccion, string NombreIdioma)
        {
            if (IdTraduccion != -1)
            {
                ...
                Seguridad.CargarBitacora(Propiedades_BE.SingletonLogIn.GlobalIdUsuario, DateTime.Now, "Baja Traduccion", "Baja",0);
                ListarTraducciones(NombreIdioma);
                LimpiarTxt();
            }
            IdTraduccion = -1;
        ...
        void Modificar(int IdTraduccion, string NombreIdioma, string Original, string Traducido)
        {
            if (IdTraduccion != -1)
            {
                ...
                Seguridad.CargarBitacora(Propiedades_BE.SingletonLogIn.GlobalIdUsuario, DateTime.Now, "Modificar Traduccion", "Baja",0);
                ListarTraducciones(NombreIdioma);
                LimpiarTxt();
            }
            IdTraduccion = -1;
